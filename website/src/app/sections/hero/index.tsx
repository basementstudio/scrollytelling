...
export const Hero = () => {
  ...
  return (
    <Scrollytelling.Root
      ...
      callbacks={{
        onUpdate: (st) => {
          useAnimationHeroStore.setState({ progress: st.progress });
        },
      }}
    >
      <Scrollytelling.Pin childHeight={'100vh'} pinSpacerHeight={'200vh'} top={0}>
        <header className={s['header']}>
          ...
          <svg className={s['star']} fill="none" viewBox="0 0 679 120" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#a)">
              <path
                fill="#fff"
            ...
            >
              <g>
                <circle cx="341" cy="60" r="60" fill="#FF4D00"></circle>
                <path
                  stroke="#000"
                  strokeMiterlimit="10"
                  strokeWidth="2.039"
                ...
                ></path>
                <path stroke="#000" strokeMiterlimit="10" strokeWidth="2.039" d="M340.864 21.806l.325 76.503"></path>
                <path
                  fill="#000"
            ...
            <defs>
              <clipPath id="a">
                <path fill="#fff" d="M249 22H0v75h249z"></path>
              </clipPath>
              <clipPath id="b">
                <path fill="#fff" d="M430 97h249V22H430z"></path>
              </clipPath>
            </defs>
          </svg>
          ...
          <div className="wrapper">
            <div className={s['content']}>
              <div className={s['svg__container']}>
                ...
                >
                  <svg className={s['svg-we']} viewBox="0 0 543 183" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      fill="white"
                    />
                    <path d="M339.823 0V183H400.618V140.769V109.096V71.5577V42.2308V0H339.823Z" fill="white" />
                    <Scrollytelling.Animation
                      tween={{
                        start: 20,
                        end: 100,
                    ...
                    >
                      <rect x="400" y="141" width="143" height="42" fill="white" />
                    </Scrollytelling.Animation>
                    <Scrollytelling.Animation
                      tween={{
                        start: 20,
                    ...
                    >
                      <rect x="400" y="71" width="143" height="38" fill="white" />
                    </Scrollytelling.Animation>
                    <Scrollytelling.Animation
                      tween={{
                        start: 20,
                ...
                >
                  <svg className={s['svg-make']} fill="none" ref={svgMakeRef} viewBox="0 0 924 187" xmlns="http://www.w3.org/2000/svg">
                    <path
                    ...
                    <path
                      ...
                      fill="white"
                    />
                    <path d="M527.698 187H588.493V167.581L620.858 127.544L656.62 187H731.362L664.13 80.0744L727.786 0H662.163L588.493 94.459V0H527.698V187Z" fill="white" />
                    <path d="M741.257 0V187H924V143.846H802.052V111.481H916.49V73.1218H802.052V43.1538H923.642V0H741.257Z" fill="white" />
                  </svg>
                </Scrollytelling.Animation>
              </div>
              <div>
                <svg className={s['svg-coolshit']} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1856 258" fill="none">
                  <path
                    fill="#fff"
                    fillRule="evenodd"
              ...
              <div className={s['svg__container']}>
                ...
                >
                  <svg className={s['svg-that']} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 415 115" fill="none">
                    <Scrollytelling.Animation
                      tween={{
                        start: 0,
                        end: 100,
                ...
                >
                  <svg className={s['svg-performs']} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1118 115" fill="none">
                    <path
                      fill="#fff"
              ...
              <div className={s['footer']}>
                <p>
                  We’re a boutique studio of ambitious creatives working at the edge of performant and immersive digital experiences, giving 110% to bring projects from a realm of
                  ideas to reality through branding, visual design & development of the highest quality.
                </p>
                <svg viewBox="0 0 24 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14 0.226562L24 6.00007L14 11.7736L14 7.00006L0 7.00006V5.00006L14 5.00007L14 0.226562Z" fill="white" />
                </svg>
                <p>
                  We don&apos;t settle, we are intentional about building with surgical precision and creating extraordinary experiences. We go the extra mile, and then walk a
                  couple more,
                  <br /> just for fun.
                </p>
