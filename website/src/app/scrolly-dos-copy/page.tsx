...
import { columns } from "./people";
import { Fragment } from "react";
import { news } from "./news";
import * as Scrollytelling from "@bsmnt/scrollytelling";
import { SuperminiAnimation } from "./supermini-animation";
    ...
    >
      <Scrollytelling.Root>
        <div className="h-[100vh]">
          <div className="z-10 h-[60vh] flex items-center sticky top-0">
            <Scrollytelling.Animation
              tween={{ start: 0, end: 50, to: { scaleY: 0, ease: "linear" } }}
            >
              <h2
                style={{
                  ...yellowtail.style,
      ...
      <Scrollytelling.Root start="top bottom" end="bottom top" debug>
      ...
      <Scrollytelling.Root start="top bottom">
