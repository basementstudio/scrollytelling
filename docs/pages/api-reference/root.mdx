...
Allows the creation of the timeline, scrollTrigger and their configuration; provides React Context.
...
| `toggleActions` |                     | Optional: Sets how the anim is handled at toggle points (onEnter, onLeave, onEnterBack, and onLeaveBack) |                 - |
